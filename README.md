# SMGDecomp
An in-development, matching decompilation of Super Mario Galaxy. All code in this repository will compile 1:1 to the original game when using the original compiler on the highest optimization level.
